...
if( $custom_header ){
	...
	if( $current_user->exists() ){
		...
		$profile_li .= '<div class="l_x"><a href="'.get_edit_profile_url($current_user->ID).'">'.$avatar_url.'</a><div class="l_l_l phnosee">你好,'.$current_user->display_name.',欢迎 回来<br> <span class="phnosee">进入我的 </span><a href="'.get_edit_profile_url($current_user->ID).'">[ 个人中心 ]</a> | <a href="'.wp_logout_url( $url_this).'"  data-no-instant>[ 退出 ]</a></div></div>';
